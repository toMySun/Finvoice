...
class FinvoiceReceiverInfo(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        ...
        if FinvoiceReceiverInfo.subclass:
            ...
            return FinvoiceReceiverInfo(*args_, **kwargs_)
    ...
    def get_ReceiverInfoTimeStamp(self): return self.ReceiverInfoTimeStamp
    def set_ReceiverInfoTimeStamp(self, ReceiverInfoTimeStamp): self.ReceiverInfoTimeStamp = ReceiverInfoTimeStamp
    ...
    def get_ProposedDueDate(self): return self.ProposedDueDate
    def set_ProposedDueDate(self, ProposedDueDate): self.ProposedDueDate = ProposedDueDate
    def get_ProposedInvoicePeriod(self): return self.ProposedInvoicePeriod
    def set_ProposedInvoicePeriod(self, ProposedInvoicePeriod): self.ProposedInvoicePeriod = ProposedInvoicePeriod
    def get_BuyerServiceCode(self): return self.BuyerServiceCode
    def set_BuyerServiceCode(self, BuyerServiceCode): self.BuyerServiceCode = BuyerServiceCode
    ...
    def hasContent_(self):
        if (
            ...
            self.ReceiverInfoTimeStamp is not None or
            self.BuyerPartyDetails is not None or
            self.InvoiceRecipientDetails is not None or
            self.ProposedDueDate is not None or
            self.ProposedInvoicePeriod is not None or
            self.BuyerServiceCode is not None or
            self.ConversionDetails is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='FinvoiceReceiverInfo', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='FinvoiceReceiverInfo')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='FinvoiceReceiverInfo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='FinvoiceReceiverInfo', fromsubclass_=False, pretty_print=True):
        ...
        if self.ProposedDueDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sProposedDueDate>%s</%sProposedDueDate>%s' % (namespace_, self.gds_format_integer(self.ProposedDueDate, input_name='ProposedDueDate'), namespace_, eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'ReceiverInfoTimeStamp':
        ...
        elif nodeName_ == 'ProposedDueDate':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
...
# end class FinvoiceReceiverInfo
...
class InvoiceRecipientDetailsType(GeneratedsSuper):
    ...
    def get_EpiRemittanceIdentifier(self): return self.EpiRemittanceIdentifier
    def set_EpiRemittanceIdentifier(self, EpiRemittanceIdentifier): self.EpiRemittanceIdentifier = EpiRemittanceIdentifier
    ...
    def hasContent_(self):
        if (
            ...
            self.SellerInvoiceIdentifier or
            self.EpiRemittanceIdentifier is not None or
            self.InvoiceRecipientLanguageCode is not None
        ):
            return True
        else:
            return False
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'EpiRemittanceIdentifier':
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        ...
        rootClass = FinvoiceReceiverInfo
