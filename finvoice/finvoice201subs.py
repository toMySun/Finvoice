...
#   ('-s', 'finvoice/finvoice201subs.py')
#   ('-o', 'finvoice/finvoice201.py')
#   ('--super', 'finvoice.finvoice')
#   ('--external-encoding', 'iso8859-15')
#   ('--no-dates', '')
#   ('--no-versions', '')
#   ('--validator-bodies', 'stubs/validator/finvoice/')
#   ('--user-methods', 'generators.gends_user_methods_finvoice')
#
# Command line arguments:
#   xsd/Finvoice2.01.xsd
#
# Command line:
#   /home/aisopuro/.virtualenvs/py-finvoice/bin/generateDS.py -s "finvoice/finvoice201subs.py" -o "finvoice/finvoice201.py" --super="finvoice.finvoice" --external-encoding="iso8859-15" --no-dates --no-versions --validator-bodies="stubs/validator/finvoice/" --user-methods="generators.gends_user_methods_finvoice" xsd/Finvoice2.01.xsd
#
