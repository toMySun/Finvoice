...
#   ('-s', 'finvoice/finvoicesubs.py')
#   ('-o', 'finvoice/finvoice.py')
...
#
# Command line:
#   /home/aisopuro/.virtualenvs/py-finvoice/bin/generateDS.py -s "finvoice/finvoicesubs.py" -o "finvoice/finvoice.py" --super="finvoice.finvoice" --external-encoding="iso8859-15" --no-dates --no-versions --validator-bodies="stubs/validator/finvoice/" --user-methods="generators.gends_user_methods_finvoice" xsd/Finvoice.xsd
#
